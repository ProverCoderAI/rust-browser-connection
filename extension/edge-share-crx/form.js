import { d as defaultSettings, l as loadSettings, s as storeSettings } from "./settings.js";
(function polyfill() {
...
const PreferencesForm = ({}) => {
  const [initialSettings, setInitialSettings] = React.useState(defaultSettings);
  const [settings, setSettings] = React.useState(defaultSettings);
  const [isAllowedIncognitoAccess, setIsAllowedIncognitoAccess] = React.useState(false);
  React.useEffect(() => {
    loadSettings().then((settings2) => {
  ...
  const saveSettings = React.useCallback((e) => {
    if (!e.currentTarget.reportValidity())
      return;
    e.preventDefault();
    storeSettings(settings).then(() => setInitialSettings(settings)).catch(() => {
    });
  }, [settings]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "preferences-form", onSubmit: saveSettings, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "sidepanel", className: "row", children: "Open in Side Panel:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "checkbox",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "playInIncognito", className: "row", children: "Play in incognito:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
      ...
      !isAllowedIncognitoAccess && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "note error", children: "This feature requires the extension to be allowed to run in incognito mode." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "experimental", className: "row", children: "Allow experimental features:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "checkbox",
