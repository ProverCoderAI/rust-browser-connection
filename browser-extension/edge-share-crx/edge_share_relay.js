...
async function tryReusePlatformShare(request) {
  ...
  await persistState({
    ...
    deviceLabel: request.deviceLabel || state.deviceLabel,
    browserKind: request.browserKind || detectBrowserKind(),
    browserLabel: request.browserLabel || request.browserName || state.browserLabel,
